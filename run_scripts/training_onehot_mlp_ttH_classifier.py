...
from onehot_mlp.onehot_mlp_ttH_classifier import OneHotMLP
...
cl = OneHotMLP(train.nfeatures, hidden_layers, outsize, model_location, 
        ...
        act_func=act_func, diff_param=diff_param)
cl.train(train, val, optimizer=optname, epochs=N_EPOCHS, batch_size=batch_size, 
        ...
        batch_decay_options=batch_decay_options, gpu_usage=gpu_usage, ttH_penalty=ttH_penalty)
