...
modeldir = os.getcwd() + '/Aufgabe3d'
if not os.path.isdir(modeldir):
    if os.path.isdir(os.path.dirname(modeldir)):
        os.mkdir(modeldir)

# Selection of data sets
train_path = '/local/scratch/NNWorkshop/datasets/data_set_3/64/train.npy'
val_path = '/local/scratch/NNWorkshop/datasets/data_set_3/64/val.npy'
...
variableList_path = '/local/scratch/NNWorkshop/datasets/data_set_3/64/vars.txt'
